...
I am a **Software Engineer**. I like to make hobbyist projects around [Hyperledger Fabric(Blockchain)](https://hyperledger-fabric.readthedocs.io/en/latest/index.html) and Raspberry Pi.
I am also trying to learn Penetration Testing using CTFs and doing simulation attacks using a pair of Virtual Machines(Target and Command Center)
